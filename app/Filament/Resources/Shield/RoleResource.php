...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    {
        // Usar Utils para determinar si se debe mostrar el grupo de navegación
        return Utils::isResourceNavigationGroupEnabled()
            ? __('Ajustes') // Aquí el grupo de navegación será 'Settings' si está habilitado
            : null; // Si no está habilitado, no se muestra en ningún grupo
    }
